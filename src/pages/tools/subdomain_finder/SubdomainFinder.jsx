      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          <div className="flex items-center justify-center gap-3 mb-4">
            ...
            <h1 className="text-4xl font-bold text-gray-900">Subdomain Finder</h1>
          </div>
        ...
        {result && (
          ...
          >
            ...
            {/* Subdomains List */}
            <div className="bg-white rounded-2xl shadow-lg p-6">
              <h3 className="text-xl font-bold text-gray-900 mb-4">Discovered Subdomains</h3>
        ...
        {!result && !loading && !error && (
          ...
          >
            ...
            <h3 className="text-xl font-semibold text-gray-900 mb-2">How Subdomain Discovery Works</h3>
